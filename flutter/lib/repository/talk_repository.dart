...
class TalksRepository {
  ...
  Future<List<Talk>> getRandomTalks(int number) async {
    var url = Uri.parse('https://220hbpr3wb.execute-api.us-east-1.amazonaws.com/default/getRandomTalks');
  ...
  Future<Talk> getTalk(String slug) async {
    var url = Uri.parse('https://zwyitz95oe.execute-api.us-east-1.amazonaws.com/default/Get_Talks_By_Tag2');
